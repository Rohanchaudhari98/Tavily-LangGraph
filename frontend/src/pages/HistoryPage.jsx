// Page that displays the user's query history with options to view or delete each query
...
export default function HistoryPage() {
  ...
  // State to store queries, loading status, and error messages
  ...
  // Return a badge element based on query status
  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <div className="bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 text-white">
        <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-extrabold mb-2 text-white">Query History</h1>
              <p className="text-blue-100 text-lg">Your Analysis History</p>
            </div>

            {/* Button to create a new analysis */}
            <button
              onClick={() => navigate('/')}
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-8 sm:px-6 lg:px-8">
        {/* Display error if fetching queries failed */}
        {error && (
        ...
        {queries.length === 0 ? (
          <div className="card p-16 text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              Start by creating your first competitive intelligence analysis
            </p>
              ...
              >
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1 min-w-0">
                    {/* Query header with company name and status */}
